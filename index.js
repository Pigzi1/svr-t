...
app.post("/submit", (req, res) => {
  ...
  var rndAdj = adj[Math.floor(adj.length * Math.random())];
  var rndNoun = noun[Math.floor(noun.length * Math.random())];
  var name = rndAdj + " " + rndNoun;
  res.render("index.ejs", {yN: name})
